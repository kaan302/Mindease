            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <div class="owl-carousel header-carousel">
                <div class="owl-carousel-item position-relative">
                  ...
                  >
                    <swiper-slide><img src="src/assets/img/carousel-1.jpg" alt=""></swiper-slide>
                    <swiper-slide><img src="src/assets/img/carousel-2.jpg" alt=""></swiper-slide>
                    <swiper-slide><img src="src/assets/img/carousel-3.jpg" alt=""></swiper-slide>
